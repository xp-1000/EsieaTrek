...
// Class Camera créée par Koopa
// utilisée pour le scrolling
// Cf. http://slick.javaunlimited.net/viewtopic.php?t=1906
...
public class Camera {
   ...
   public void centerOn(float x, float y) {
      ...
      if(mapWidth < gc.getWidth()) cameraX = (mapWidth -gc.getWidth()) / 2;
	  if(mapHeight < gc.getHeight()) cameraY = (mapHeight - gc.getHeight()) / 2;
